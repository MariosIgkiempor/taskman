...
export function TagPicker({ tags, selectedTagIds, onToggle, onCreate, onClose, searchQuery, inline = false }: TagPickerProps) {
    ...
    return (
        ...
        >
            {filteredTags.length === 0 && !searchQuery && (
                <div className="px-2 py-3 text-center text-xs text-muted-foreground">No tags yet. Type # to create one.</div>
            )}
