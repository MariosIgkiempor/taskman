  ...
  return (
    ...
    >
      ...
      <PopoverContent
        ...
        collisionPadding={16}
        className="data-[state=open]:fade-in-0 data-[state=open]:zoom-in-[0.98] origin-top p-0 data-[state=open]:animate-in"
...
function TaskCreateForm({
  ...
  const handleCreateTag = useCallback(
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
    [onTagCreated, form.setData, workspace],
  );
    ...
    <div className="flex flex-col">
      ...
      <div className="px-3 pt-3">
        <Input
          ...
          className="border-0 px-0 font-semibold text-sm shadow-none focus-visible:ring-0"
      ...
      {boards.length > 1 && (
        <div className="px-3 pb-1">
          <select
            ...
            className="w-full rounded-md border-0 bg-muted/50 px-2 py-1 text-muted-foreground text-xs outline-none"
          >
            {boards.map((board) => (
      ...
      <div className="flex items-center gap-1 border-border/50 border-t px-2 py-1.5">
        ...
        <Button
          variant="ghost"
          size="sm"
          className="h-7 gap-1.5 px-2 text-primary text-xs"
